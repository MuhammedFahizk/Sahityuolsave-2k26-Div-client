...
export const metadata = {
  ...
  description: "SSF Mavoor Division  Sahityolsave 2026 — results, teams, gallery, and news.",
  keywords: ["SSF", "Sahityolsave", "Mavoor", "festival", "arts", "cultural"],
  authors: [{ name: "SSF Mavoor Division" }],
  openGraph: {
    title: "SSF Sahityolsave 2026",
    description: "SSF Mavoor Division — results, teams, gallery, and news.",
    type: "website",
    locale: "en_IN",
  },
};
