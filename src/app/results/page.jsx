...
function SortDropdown({ value, onChange }) {
  ...
  return (
    <div ref={ref} className="relative flex-shrink-0 pe-2">
      <button
        onClick={() => setOpen((o) => !o)}
    ...
    <div className="relative flex-1">
      ...
      <input
        ...
        onKeyDown={(e) => e.key === "Enter" && onCommit()}
         placeholder="Search program name or participant name..."
...
export default function ResultsPage() {
  ...
  const hasFilters =
    activeGroup || search || sort !== "newest" || activeTeamId || activeType;

  // Filter categories based on activeType:
  // If campus selected, show only Campus. If sector or All, show everything except Campus.
  const groupOptions = groups
    .filter((g) => {
      const isCampus = g.toLowerCase() === "campus";
      return activeType === "campus" ? isCampus : !isCampus;
    })
